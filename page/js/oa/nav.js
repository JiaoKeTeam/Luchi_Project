$(function () {
    ...
    $("#persional_attendance").on("click", function () {
        removeOwnName();
        personal(this);
        $('#oa-iframe').attr("src", "personal/oa_personal_attendance.html");
    });
    ...
    $("#schedule_planning").on("click", function () {
        removeOwnName();
        personal(this);
        $('#oa-iframe').attr("src", "personal/oa_schedule_planning.html");
    });
    ...
    $("#notepad").on("click", function () {
        removeOwnName();
        personal(this);
        $('#oa-iframe').attr("src", "personal/oa_notepad.html");
    });
    ...
    $("#new_matter").on("click", function () {
        window.open('collaboration/oa_new_matter.html', '_blank', 'height=700, width=1400, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');
    });
    ...
    $("#waiting_matter").on("click", function () {
        ...
        $("#oa-iframe").attr("src", "collaboration/oa_waiting_matter.html")
    });
    ...
    $("#already_issued_matter").on("click", function () {
        removeOwnName();
        synergetic_work(this);
        $("#oa-iframe").attr("src", "collaboration/oa_already_issued_matter.html")
    });
    ...
    $("#to_do_matter").on("click", function () {
        removeOwnName();
        synergetic_work(this);
        $("#oa-iframe").attr("src", "collaboration/oa_upcoming_matter.html")
    });
    ...
    $("#managed_matter").on("click", function () {
        removeOwnName();
        synergetic_work(this);
        $("#oa-iframe").attr("src", "collaboration/oa_managed_matter.html")
    });
    ...
    $("#supervision_matters").on("click", function () {
        removeOwnName();
        synergetic_work(this);
        $("#oa-iframe").attr("src", "collaboration/oa_supervision_matters.html")
    });

    /*--- 公文管理 ---*/
    //公文发布
    $("#document_processing").on("click", function () {
        window.open('document/oa_document_processing.html', '_blank', 'height=700, width=1400, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');
    });
    ...
    $("#waiting_document").on("click", function () {
        removeOwnName();
        document(this);
        $("#oa-iframe").attr("src", "document/oa_waiting_document.html")
    });
    ...
    $("#document_signing").on("click", function () {
        removeOwnName();
        document(this);
        $("#oa-iframe").attr("src", "document/oa_document_signing.html")
    });
    ...
    $("#historical_documents").on("click", function () {
        removeOwnName();
        document(this);
        $("#oa-iframe").attr("src", "document/oa_documents_historical.html")
    });
    ...
    $("#employee_files").on("click", function () {
        removeOwnName();
        archives(this);
        $('#oa-iframe').attr("src", "archives/oa_employee_files.html");
    });
    ...
    $("#dispatch_file").on("click", function () {
        removeOwnName();
        archives(this);
        $('#oa-iframe').attr("src", "archives/oa_dispatch_file.html");
    });
    ...
    $("#contract_archives").on("click", function () {
        removeOwnName();
        archives(this);
        $('#oa-iframe').attr("src", "archives/oa_contract_archives.html");
    });
    ...
    $("#meeting_schedule").on("click", function () {
        removeOwnName();
        meeting(this);
        $("#oa-iframe").attr("src", "meeting/oa_meeting_schedule.html");
    });
    ...
    $("#conference_calendar").on("click", function () {
        removeOwnName();
        meeting(this);
        $("#oa-iframe").attr("src", "meeting/oa_conference_calendar.html")
    });
    ...
    $("#not_open_meeting").on("click", function () {
        removeOwnName();
        meeting(this);
        $("#oa-iframe").attr("src", "meeting/oa_pending_meeting.html")
    });
    ...
    $("#historical_conference").on("click", function () {
        removeOwnName();
        meeting(this);
        $("#oa-iframe").attr("src", "meeting/oa_historical_conference.html")
    });
    ...
    $("#conference_resources").on("click", function () {
        removeOwnName();
        meeting(this);
        $("#oa-iframe").attr("src", "meeting/oa_conference_resources.html")
    });
    ...
    $("#resource_storage").on("click", function () {
        removeOwnName();
        resources(this);
        $('#oa-iframe').attr("src", "resources/oa_resource_storage.html");
    });
    ...
    $("#resources_archives").on("click", function () {
        removeOwnName();
        resources(this);
        $('#oa-iframe').attr("src", "resources/oa_resources_archives.html");
    });
    ...
    $("#apply_resource").on("click", function () {
        removeOwnName();
        resources(this);
        $('#oa-iframe').attr("src", "resources/oa_resource_apply.html");
    });
    ...
    $("#receive_record").on("click", function () {
        removeOwnName();
        resources(this);
        $('#oa-iframe').attr("src", "resources/oa_receive_record.html");
    });
    ...
    $("#announcements").on("click", function () {
        ...
        $('#oa-iframe').attr("src", "culture/oa_announcements.html");
    });
    ...
    $("#news").on("click", function () {
        removeOwnName();
        cultural_construction(this);
        $('#oa-iframe').attr("src", "culture/oa_news_center.html");
    });

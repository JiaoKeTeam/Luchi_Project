...
function right_change(id) {
    ...
    switch (id) {
        ...
        case 'persional_attendance':
            $('#oa-iframe').attr("src", "oa_personal_attendance.html");
        ...
        case 'schedule_planning':
            $('#oa-iframe').attr("src", "schedule/oa_schedule_planning.html");
        ...
        case 'persional_salary':
            $('#oa-iframe').attr("src", "oa_personal_salary.html");
        ...
        //待办记事
        case 'do_not':
            $('#oa-iframe').attr("src", "oa_notepad.html");
        ...
        //新建事项
        case 'new_matter':
            window.open('oa_new_matter.html', '_blank', 'height=700, width=1400, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');
        ...
        //待发事项
        case 'waiting_matter':
            $("#oa-iframe").attr("src", "oa_waiting_matter.html")
        ...
        case 'already_issued_matter':
            $("#oa-iframe").attr("src", "oa_already_issued_matter.html")
        ...
        //待办事项
        case 'to_do_matter':
            $("#oa-iframe").attr("src", "oa_upcoming_matter.html")
        ...
        //已办事项
        case 'managed_matter':
            $("#oa-iframe").attr("src", "oa_managed_matter.html")
        ...
        case 'supervision_matters':
            $("#oa-iframe").attr("src", "oa_supervision_matters.html")
        ...
        case 'document_processing':
            //更改引用
            window.open('oa_document_processing.html', '_blank', 'height=700, width=1400, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');
            //添加选择后样式
        ...
        case 'waiting_document':
            //更改引用
            $("#oa-iframe").attr("src", "oa_waiting_document.html")
            //添加选择后样式
        ...
        case 'document_signing':
            //更改引用
            $("#oa-iframe").attr("src", "oa_document_signing.html")
            //添加选择后样式
        ...
        case 'historical_documents':
            //更改引用
            $("#oa-iframe").attr("src", "oa_documents_historical.html")
            //添加选择后样式
        ...
        //自有员工档案
        case 'employee_files':
            $('#oa-iframe').attr("src", "oa_employee_files.html");
        ...
        //劳务派遣档案
        case 'dispatch_file':
            $('#oa-iframe').attr("src", "oa_dispatch_file.html");
        ...
        case 'conference_resources':
            $("#oa-iframe").attr("src", "oa_conference_resources.html")
        ...
        case 'not_open_meeting':
            $("#oa-iframe").attr("src", "oa_pending_meeting.html")
        ...
        case 'historical_conference':
            $("#oa-iframe").attr("src", "oa_historical_conference.html")
        ...
        case 'conference_calendar':
            $("#oa-iframe").attr("src", "oa_conference_calendar.html")
        ...
        case 'meeting_schedule':
            $("#oa-iframe").attr("src", "oa_meeting_schedule.html");
        ...
        case 'resource_storage':
            $('#oa-iframe').attr("src", "oa_resource_storage.html");
        ...
        case 'resources_archives':
            $('#oa-iframe').attr("src", "oa_resources_archives.html");
        ...
        //申领资源
        case 'apply_resource':
            $('#oa-iframe').attr("src", "oa_resource_apply.html");
        ...
        //申领记录
        case 'receive_record':
            $('#oa-iframe').attr("src", "oa_receive_record.html");
        ...
        //公告管理
        case 'announcements':
            $('#oa-iframe').attr("src", "oa_announcements.html");
        ...
        //新闻管理
        case 'news':
            $('#oa-iframe').attr("src", "oa_news_center.html");
